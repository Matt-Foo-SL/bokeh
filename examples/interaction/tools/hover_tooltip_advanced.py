...
p = figure(
    title="Demonstrates hover tool with advanced and regular tooltip formatting and filtering side-by-side",
    tools="pan,wheel_zoom,box_select,crosshair",
)

p.circle(x, y, radius=radii, fill_color=colors, fill_alpha=0.6, line_color=None)

x_filter = CustomJS(code="""export default (_, __, {value: x}) => 20 <= x && x <= 80""")
y_filter = CustomJS(code="""export default (_, __, {value: y}) => 20 <= y && y <= 80""")
